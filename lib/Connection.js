 ...
 * @param {Object} socketOptions - an object passed to net.connect or tls.connect, if `socketOptions.secure` is `true`
 */
 ...
 * Most of times, {@link Connection#info} (and its family) and {@link Connection#bind} will be
 * much more useful.
 * @param {Object} data
 ...
 * @private
 */
Connection.prototype._base = function (time, level, name, message, extra) {
